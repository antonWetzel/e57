use crate::{
	date_time::date_time_from_node, error::Converter, transform::transform_from_node, DateTime, Error, Result,
	Transform,
};
use roxmltree::Node;
use std::str::FromStr;
...
pub fn optional_integer<T: FromStr + Sync + Send>(parent_node: &Node, tag_name: &str) -> Result<Option<T>> {
